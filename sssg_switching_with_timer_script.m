function [energy_gain, delays] = sssg_switching_with_timer_script(T_total, scs, SSSG0_frequency, SSSG1_frequency, P_switch, ...
    searchSpaceSwitchTimer, packet_frequency, packet_data_duration, buffor_before_dci)
    % Input parameters
    ...
    fprintf('searchSpaceSwitchTimer value in slots: %d \n', searchSpaceSwitchTimer);
    fprintf('Packet frequency: %d ms\n', packet_frequency);
    fprintf('Buffor in ms indicating when DCI 2_0 is send: %d ms\n', buffor_before_dci);
    ...
    while remaining_time > 0
        ...
        while next_packet_index <= length(packet_arrivals) && ...
              packet_arrivals(next_packet_index) <= current_slot_time
                ...
                if monitoring_counter > 0
                    ...
                    switch monitoring_type 
                        ...
                        case 'p_switch'
                            ...
                            monitoring_counter = searchSpaceSwitchTimer;
                            monitoring_type = 'searchSpaceSwitchTimer';
